  ...
  return (
    <div className="w-full animation-fade-in-up">
      <div className="mb-7">
        ...
        <p className="text-body text-secondary">Enter your credentials to access your graph.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex justify-end">
            <Link href="/forgot-password" className="text-callout text-[var(--accent)] hover:underline">
              Forgot password?
            </Link>
          </div>
        </div>
      ...
      <SocialAuthButtons mode="login" onSuccess={() => router.replace("/home")} onError={setError} />
